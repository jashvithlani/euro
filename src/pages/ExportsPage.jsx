  ...
  return (
    <>
              ...
              <section className="export-hero">
                <div className="export-hero-grid">
                  ...
                  <div className="export-hero-media">
                    <img src="assets/exports-hero.png" alt="Shipping containers at sunset" />
                ...
                <div className="export-story-grid">
                  ...
                  <div className="export-story-media">
                    <figure className="export-wafers-card">
                      <img src="assets/exports-wafers.png" alt="Crispy banana wafers in a glass bowl" />
                      <figcaption>Premium Quality</figcaption>
                    </figure>
                    <img className="export-factory-image" src="assets/exports-factory.png" alt="Food manufacturing machinery" />
                  </div>
                </div>
              </section>
                ...
                <div className="export-inquiry-inner">
                  ...
                  <form className="export-form" action="#">
                    ...
                    <div className="export-form-actions">
                      <button type="submit">
                        Submit Inquiry
                        <img src="assets/exports-icon-arrow.svg" alt="" aria-hidden="true" />
                      </button>
                    </div>
                  </form>
                </div>
            ...
            <section className="export-footprint">
              ...
              <img src="assets/exports-map.png" alt="India map showing Euro India Foods domestic footprint" />
            </section>
    </>
  );
}
