  ...
  return (
    <main className="contact-main">
      ...
      <section className="contact-social" aria-label="Euro India social feed">
        <img className="contact-social-strip" src="assets/contact-social-strip.png" alt="Euro India social feed" />
        <img className="contact-social-vector" src="assets/contact-social-vector.png" alt="" aria-hidden="true" />
      </section>
    </main>
  );
}
