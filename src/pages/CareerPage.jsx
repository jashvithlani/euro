        ...
        <section className="career-hero">
          ...
          <div className="career-hero-media">
            ...
            <div className="career-hero-photo">
              <img src="assets/career-hero-team.png" alt="Team collaborating in a modern office" />
          ...
          <form className="career-form">
            <div className="career-form-grid">
              ...
              <label className="career-upload career-field-wide">
                ...
                <div>
                  <img src="assets/career-icon-upload.svg" alt="" />
