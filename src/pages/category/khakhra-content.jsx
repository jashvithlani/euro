...
const khakhraAt1920 = {
  ...
  sections: [
    /* Row 1 — Masala + 7 Grain banner cards (Figma Frame 10 @ y=1024 -> 683px) */
    {
      ...
      imageStyle: { left: 496, top: 51.19, width: 261.48, height: 285.5, transform: "rotate(2deg)" },
    ...
    /* Row 3 — Jeera, Pani Puri, Oats (Figma Frame 11 row 2 @ abs y=1895 -> 1263px) */
    {
      ...
      imageStyle: { left: 294, top: 57, width: 246, height: 271 },
      title: "Jeera\nKhakhra",
      titleClass: "text-khakhra-red product-title-lg khakhra-title-portrait",
    ...
    },
    {
      ...
      imageStyle: { left: 294, top: 55, width: 246, height: 264 },
      title: "Pani Puri\nKhakhra",
      titleClass: "text-khakhra-red product-title-lg khakhra-title-portrait",
    ...
    },
    {
      ...
      imageStyle: { left: 294, top: 61, width: 246, height: 264 },
      title: "Oats\nKhakhra",
      titleClass: "text-khakhra-red product-title-lg khakhra-title-portrait",
      titleStyle: { left: 34.25, top: 34.78, width: 321 },
    },
    /* Row 4 — Chorafali, Bajri, Garlic (Figma bottom grid @ y=2322 -> 1548px) */
    {
      ...
      imageStyle: { left: 299, top: 61, width: 246, height: 264 },
      title: "Chorafali\nKhakhra",
      titleClass: "text-khakhra-red product-title-lg khakhra-title-portrait",
      titleStyle: { left: 33, top: 35, width: 274 },
    },
