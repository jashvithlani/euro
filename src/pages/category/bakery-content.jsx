...
const bakeryAt1920 = {
  ...
  sections: [
    ...
    },
    {
      ...
      imageInnerStyle: { left: "-26.19%", top: "-22.19%", width: "147.78%", height: "122.19%" },
      title: "Coconut\nNankhatai",
      titleClass: "text-bakery-gold product-title-lg",
      titleStyle: { left: 11.68, top: 29.08, width: 321.26 },
    },
    {
      type: "productCard",
      left: 1287,
      ...
      imageInnerStyle: { left: "-25.99%", top: "-24.29%", width: "150.7%", height: "124.29%" },
      title: "Surati\nNankhatai",
      titleClass: "text-bakery-gold product-title-lg",
