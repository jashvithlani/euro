...
const cardTexture = "asset('category-card-texture.png')";
const namkeenTexture = "asset('category-namkeen-card-bg.png')";
...
const pages = {
  ...
  beverages: {
    ...
    hero: {
      mode: "image",
      image: asset('category-beverages-hero-products.png'),
    ...
    sections: [
      {
        ...
        texture: asset('category-chikki-card-texture.png'),
        textureOpacity: 0.06,
    ...
    sections: [
      {
        ...
        texture: asset('category-khakhra-card-texture.png'),
        textureOpacity: 0.06,
    ...
    sections: [
      {
        ...
        texture: asset('category-bakery-card-texture.png'),
        textureOpacity: 0.07,
    ...
    sections: [
      {
        ...
        texture: asset('category-fryums-card-texture.png'),
        textureOpacity: 0.04,
  ...
  if (hero.mode === "getmore") {
    return (
      <div className="category-hero-custom category-hero-getmore" aria-hidden="true">
        ...
        <img className="getmore-hero-pack getmore-hero-pack-red" src={asset('category-getmore-tomato.png')} alt="" />
        <img className="getmore-hero-pack getmore-hero-pack-blue" src={asset('category-getmore-chatpata.png')} alt="" />
      </div>
    );
  }
